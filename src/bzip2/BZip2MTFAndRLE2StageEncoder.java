...
public class BZip2MTFAndRLE2StageEncoder {
    ...
    /**
     * At each position, {@code true} if the byte value with that index is
     * present within the block, otherwise {@code false}
     */
     ...
     * @param bwtValuesPresent The values that are present within the BWT data.
     * For each index, {@code true} if that value is present within the data,
