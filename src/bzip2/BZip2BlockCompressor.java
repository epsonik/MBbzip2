...
public class BZip2BlockCompressor {
    ...
    /**
     * @param bitOutputStream The BZip2BitOutputStream to which compressed BZip2
     * data is written
     * @param blockSize The declared block size in bytes. Up to this many bytes
     * will be accepted into the block after Run-Length Encoding is applied
     */
