...
/**
 * <p>
 * An OutputStream wrapper that compresses BZip2 data</p>
 *
 * <p>
 * Instances of this class are not threadsafe.</p>
 */
public class BZip2OutputStream extends OutputStream {
    ...
    /**
     * The declared maximum block size of the stream (before final run-length
     * decoding)
     */
    ...
    /**
     * Compress and write out the block currently in progress. If no bytes have
     * been written to the block, it is discarded
     *
    ...
    /**
     * Compresses and writes out any as yet unwritten data, then writes the end
     * of the BZip2 stream. The underlying OutputStream is not closed
     *
     * @throws IOException on any I/O error writing to the output stream
     */
     ...
     * @param blockSizeMultiplier The BZip2 block size as a multiple of 100,000
     * bytes (minimum 1, maximum 9). Larger block sizes require more memory for
     * both compression and decompression, but give better compression ratios.
     * <code>9</code> will usually be the best value to use
     * @throws IOException on any I/O error writing to the output stream
     */
    ...
    /**
     * Constructs a BZip2 stream compressor with the maximum (900,000 byte)
     * block size
     *
     * @param outputStream The output stream to write to
     * @throws IOException on any I/O error writing to the output stream
