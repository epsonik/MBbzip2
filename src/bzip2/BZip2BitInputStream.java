...
/**
 * <p>
 * An InputStream wrapper that allows the reading of single bit booleans, unary
 * numbers, bit strings of arbitrary length (up to 24 bits), and bit aligned
 * 32-bit integers. A single byte at a time is read from the wrapped stream when
 * more bits are required</p>
 */
public class BZip2BitInputStream {
    ...
    /**
     * A buffer of bits read from the input stream that have not yet been
     * returned
     */
     ...
     *
     * @return {@code true} if the bit read was {@code 1}, otherwise
     * {@code false}
     ...
     * @throws IOException if more bits are requested than are available in the
     * input stream
     */
