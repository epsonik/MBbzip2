...
public class MoveToFront {
    ...
    /**
     * Moves a value to the head of the MTF list (forward Move To Front
     * transform)
     *
    ...
    /**
     * Gets the value from a given index and moves it to the front of the MTF
     * list (inverse Move To Front transform)
     *
