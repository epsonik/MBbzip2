...
public class BZip2HuffmanStageDecoder {
     ...
     * @throws IOException if the end of the input stream is reached while
     * decoding
     */
    ...
    /**
     * @param bitInputStream The BZip2BitInputStream from which Huffman codes
     * are read
     * @param alphabetSize The total number of codes (uniform for each table)
     * @param tableCodeLengths The Canonical Huffman code lengths for each table
     * @param selectors The Huffman table number to use for each group of 50
     * symbols
     */
